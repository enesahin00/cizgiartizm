...
export const gallery: GalleryItem[] = [
  ...
  { src: "rau-cafe-afrikan-kadin-render.jpg", alt: "RAU Cafe için Afrikalı kadın portrelerinden oluşan iç mekan tasarımı", title: "RAU Cafe — Tasarım", category: "portre" },
  { src: "kirmizi-bina-cephesi-duvar-resmi-hava-fotografi.png", alt: "Renkli duvar resimleriyle kaplı uzun bina cephesinin havadan fotoğrafı", title: "Bina Cephesi — Havadan", category: "duvar" },
  ...
  { src: "buyuk-adam-portesi-bina-cephesi-yapim-asamasi.png", alt: "Sepetli vinçten çekilen büyük siyah-beyaz adam portresi yapım aşaması", title: "Dev Portre — Yapım Aşaması", category: "portre" },
  { src: "figur-siyah-beyaz-yapim-asamasi.png", alt: "Siyah-beyaz figüratif duvar resminin yapım aşaması", title: "Siyah-Beyaz Figür — Yapım Aşaması", category: "duvar" },
  ...
  { src: "fareler-kaykay-mavi-duvar-resmi.png", alt: "Mavi duvarda kaykay yapan fare karakterleri duvar resmi", title: "Kaykaycı Fareler", category: "duvar" },
  ...
  { src: "yaban-domuzu-siyah-beyaz-yapim-asamasi.png", alt: "Siyah-beyaz yaban domuzu duvar resminin yapım aşaması", title: "Yaban Domuzu — Yapım Aşaması", category: "duvar" },
  ...
  { src: "ataturk-portesi-trafo-kutusu-turk-bayragi.jpg", alt: "Türk bayrağı arka planlı Atatürk portresi trafo kutusu", title: "Atatürk Portresi", category: "portre" },
  ...
  { src: "su-altinda-kiz-yunus-gemi-duvar-resmi.jpg", alt: "Su altında yüzen kız, yunus ve batık gemi temalı gerçekçi duvar resmi", title: "Su Altında — Kız & Yunus", category: "duvar" },
